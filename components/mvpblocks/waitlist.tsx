...
export default function WaitlistPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await sendEmail({ to: email, subject: 'Thanks for signing up!', from: 'Aadit Bhambri <welcome@hello.aaditbhambri.com>' });
    setSubmitted(true);
  ...
  return (
    <main className="relative flex min-h-screen w-full items-center justify-center overflow-hidden xl:h-screen">
      ...
      <div className="relative z-[100] mx-auto max-w-2xl px-4 py-16 text-center">
        ...
        >
          Be the first to access Stamp and start excelling fast.
        </motion.p>
        ...
        >
          ...
          >
            ...
            <span className="text-muted-foreground text-xs">Quality Features</span>
          </div>
          ...
          >
            ...
            <span className="text-muted-foreground text-xs">GNU AFFERO GENERAL PUBLIC LICENSE</span>
          </div>
